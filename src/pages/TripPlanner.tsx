...
import { MapPin, Calendar, Users, DollarSign, Clock, Plus, X, MessageSquare, AlertTriangle } from "lucide-react";
              ...
              <CardContent>
                {validDestinations.length >= 2 ? (
                  ...
                  <div className="text-center py-12 text-gray-500">
                    ...
                    <p>Add at least 2 destinations to see your route on the map</p>
                  </div>
                )}
              </CardContent>
            </Card>
